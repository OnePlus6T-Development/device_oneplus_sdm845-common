...
# Component overrides
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/qti/component-overrides.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sysconfig/component-overrides.xml
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/google/privapp-permissions-hotword.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-hotword.xml
...
# IPC router config
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/qti/sec_config:$(TARGET_COPY_OUT_VENDOR)/etc/sec_config
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/qti/system_properties.xml:$(TARGET_COPY_OUT_VENDOR)/etc/system_properties.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/qti/privapp-permissions-qti.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-qti.xml
