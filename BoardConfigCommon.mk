...
BOARD_SUPER_PARTITION_GROUPS := fajita_dynamic_partitions
BOARD_FAJITA_DYNAMIC_PARTITIONS_SIZE := 4173332480 # Reserve 4MiB for overhead
BOARD_FAJITA_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
...
BOARD_KERNEL_CMDLINE += androidboot.selinux=permissive # SELinux premissive mode
