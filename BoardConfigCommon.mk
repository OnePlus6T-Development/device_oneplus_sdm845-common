...
# Partitions
BOARD_SUPER_PARTITION_BLOCK_DEVICES := super # Maybe we could add vendor soon
BOARD_SUPER_PARTITION_SUPER_DEVICE_SIZE := 6174015488
#BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 1073741824
BOARD_SUPER_PARTITION_SIZE := 6174015488
BOARD_SUPER_PARTITION_METADATA_DEVICE := super

BOARD_SUPER_PARTITION_GROUPS := oneplus_dynamic_partitions
BOARD_ONEPLUS_DYNAMIC_PARTITIONS_SIZE := 6169821184 # Reserve 4MiB for overhead
